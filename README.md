...
convention = "openai"
# Optional: seconds to wait for the upstream to begin responding. This applies
# only before response headers; established streaming responses are not cut off.
